...
vector<Order> merge_orders_asc_time()  // merges orders by sorting them in ascending order according to catering time
{
...
{   
    vector<Order> mergedOrder=merge_orders_asc_time();
